...
@property (nullable, nonatomic) UIColor *pointColor;
 ...
 *  @param scale The scale factor for the chart image.
 *  @param edgeInsets The edge insets for the chart image.
 *
 *  @return An line chart drawed `UIImage` object.
 */
- (UIImage * _Nonnull)drawImageIn:(CGRect)frame scale:(CGFloat)scale edgeInsets:(UIEdgeInsets)edgeInsets;
